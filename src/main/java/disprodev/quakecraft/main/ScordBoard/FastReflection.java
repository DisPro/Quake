package disprodev.quakecraft.main.ScordBoard;
...
public final class FastReflection {
    ...
    public static PacketConstructor findPacketConstructor(Class<?> packetClass, MethodHandles.Lookup lookup) throws Exception {
        try {
            ...
            Method allocateMethod = theUnsafe.getClass().getMethod("allocateInstance", new Class[] { Class.class });
            return () -> allocateMethod.invoke(theUnsafe, new Object[] { packetClass });
        }
    }
